...
This is the readme for JMEMovementTest, try to keep it up to date with any information future-you will wish past-you
...
- File > Open > select the top level folder of this project ( i.e. JMEMovementTest) > Ok.
...
- To run the project find JMEMovementTest.java (which will be in under src/main/java/xyz/srgnis) and right click > Run 'JMEMovementTest'
